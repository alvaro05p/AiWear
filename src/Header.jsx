    ...
    <header className="text-gray-600 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href="#">
            <img src="logoNoBackground.png" alt="" className="w-10 h-10 text-white rounded-full"/>
            <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
          <span className="ml-3 text-xl">AiWear</span>
        </a>
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          <a className="mr-5 hover:text-gray-900" href="#">Shirts</a>
          <a className="mr-5 hover:text-gray-900" href="#">Hoodies</a>
          <a className="mr-5 hover:text-gray-900" href="#">Create</a>
          <a className="mr-5 hover:text-gray-900" href="#">User designs</a>
        </nav>
